...
# Build-time only localization. We deliberately translate exact display literals
# instead of walking/modifying the WPF logical tree at runtime. This keeps the
# upstream control initialization path intact and avoids the API-settings crash.
...
# Write UTF-8 without BOM; WPF XAML compiler handles this consistently.
